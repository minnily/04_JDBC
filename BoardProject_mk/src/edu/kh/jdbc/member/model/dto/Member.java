...
public class Member {
	...
	public String toString() {
		return "Member [memberNo=" + memberNo + ", " + (memberId != null ? "memberId=" + memberId + ", " : "")
				+ (memberPw != null ? "memberPw=" + memberPw + ", " : "")
				+ (memberName != null ? "memberName=" + memberName + ", " : "")
				+ (memberGender != null ? "memberGender=" + memberGender + ", " : "")
				+ (enrollDate != null ? "enrollDate=" + enrollDate + ", " : "")
				+ (unregisterFlag != null ? "unregisterFlag=" + unregisterFlag : "") + "]";
	}
